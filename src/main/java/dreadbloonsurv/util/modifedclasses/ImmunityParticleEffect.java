...
public class ImmunityParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public ImmunityParticleEffect() {
        ...
        this.color = new Color(MathUtils.random(0.65F, 0.8F), MathUtils.random(0.65F, 0.8F), MathUtils.random(0.2F, 0.3F), 0.0F);
