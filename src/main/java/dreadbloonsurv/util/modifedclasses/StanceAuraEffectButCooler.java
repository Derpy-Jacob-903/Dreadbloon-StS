...
public class StanceAuraEffectButCooler extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public StanceAuraEffectButCooler(String stanceId) {
        this.img = ImageMaster.EXHAUST_L;
        this.duration = 2.0F;
        this.scale = MathUtils.random(2.7F, 2.5F) * Settings.scale;
        if (stanceId.equals("Wrath") || stanceId.equals("champ:BerserkerStance")) { //Attack Stances
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.0F, 0.1F), MathUtils.random(0.1F, 0.2F), 0.0F);
        } else if (stanceId.equals("Calm") || stanceId.equals("champ:DefensiveStance")) { //Set Up Stances
            this.color = new Color(MathUtils.random(0.5F, 0.55F), MathUtils.random(0.6F, 0.7F), 1.0F, 0.0F);
        } else if (stanceId.equals("Divinity") || stanceId.equals("champ:UltimateStance")){ //Hybrid Stances
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.0F, 0.1F), MathUtils.random(0.6F, 0.7F), 0.0F);
        } else if (stanceId.equals(makeID("Immunity")) || stanceId.equals("guardianmod:DefensiveMode")) { //Defense Stances
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.6F, 0.7F), MathUtils.random(0.0F, 0.1F), 0.0F);
        } else {
    ...
    public StanceAuraEffectButCooler(String stanceId, STANCECOLOR stanceColour) {
        this.img = ImageMaster.EXHAUST_L;
        this.duration = 2.0F;
        this.scale = MathUtils.random(2.7F, 2.5F) * Settings.scale;
        if (stanceColour == STANCECOLOR.RED) { //Attack Stances
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.0F, 0.1F), MathUtils.random(0.1F, 0.2F), 0.0F);
        } else if (stanceColour == STANCECOLOR.BLUE) { //Set Up Stances
            this.color = new Color(MathUtils.random(0.5F, 0.55F), MathUtils.random(0.6F, 0.7F), 1.0F, 0.0F);
        } else if (stanceColour == STANCECOLOR.PURPLE){ //Hybrid Stances
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.0F, 0.1F), MathUtils.random(0.6F, 0.7F), 0.0F);
        } else if (stanceColour == STANCECOLOR.YELLOW) { //Defense Stances
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.6F, 0.7F), MathUtils.random(0.0F, 0.1F), 0.0F);
        } else {
            this.color = new Color(MathUtils.random(0.6F, 0.7F), MathUtils.random(0.6F, 0.7F), MathUtils.random(0.6F, 0.7F), 0.0F);
        }
